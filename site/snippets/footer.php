<section id="footer" class="mt-5">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-4 offset-lg-4">
        <div class="block-font-mon-400-nor-sm">
          <a class="font-mon-400-nor-sm no-u text-uppercase mr-3" href="<?= page("privacy-policy")->url() ?>">Privacy</a>
          <a class="font-mon-400-nor-sm no-u text-uppercase mr-3" href="<?= $site->panelUrl() ?>">Login</a>
          <span class="font-mon-400-nor-sm text-uppercase mr-0">Released under CC 4.0?</span>
        </div>
      </div>
